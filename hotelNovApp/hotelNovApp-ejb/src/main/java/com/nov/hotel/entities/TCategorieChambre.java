...
public class TCategorieChambre implements Serializable{
	...
	public String toString() {
		return "TCategorieChambre [catChambreId=" + catChambreId + ", catChambreLib=" + catChambreLib
				+ ", catChambreDesc=" + catChambreDesc + ", catChambreDateCrea=" + catChambreDateCrea
				+ ", catChambreDateModif=" + catChambreDateModif + ", cliStatut=" + cliStatut + "]";
	}
